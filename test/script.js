...
switch (test_id) {
  ...
  case "16":
    test_name =
      "Українські землі в складі Австрійської імперії в другій половині ХІХ ст.";
    break;
  case "17":
    test_name =
      "Культура України в другій половині ХІХ ст. – на початку XX ст.";
    break;
  case "18":
    test_name =
      "Українські землі у складі російської імперії в 1900-1914-х роках";
    break;
  case "19":
