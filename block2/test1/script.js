...
function showScore() {
    ...
    if (score < 5) {
        document.getElementById("question").src =
            "/siteHistoryTests/grades/very_bad.jpg";
    } else if (score < 10) {
        document.getElementById("question").src =
            "/siteHistoryTests/grades/bad.jpg";
    } else if (score < 14) {
        document.getElementById("question").src =
            "/siteHistoryTests/grades/average.jpg";
    } else if (score < 16) {
        document.getElementById("question").src =
            "/siteHistoryTests/grades/good.jpg";
    } else if (score >= 16) {
        document.getElementById("question").src =
            "/siteHistoryTests/grades/very_good.jpg";
    }
    clearInterval(timerInterval);
...
q13.addEventListener("click", () => {
    document.getElementById("question").src =
        vidpovidnist_alreadyAsked[0].question;
