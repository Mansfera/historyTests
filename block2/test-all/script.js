...
let promises = [
    ...
    fetchJsonData("../test" + test_id + "/vidpovidnist_questions.json").then(function (data) {
        vidpovidnist_questions = data;
    }),
    fetchJsonData("../test" + test_id + "/hronology_questions.json").then(function (data) {
        hronology_questions = data;
    }),
    fetchJsonData("../test" + test_id + "/mul_ans_questions.json").then(function (data) {
